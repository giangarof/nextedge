...
const signup = () => {
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-100">
        <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-lg">
            ...
            <div>
                <label htmlFor="confirm-password" className="mb-2 block text-sm font-medium text-gray-700">Confirm Password</label>
            ...
            <p className="text-center flex flex-row justify-center gap-3">Already have an account? 
                <Link href='/access/login' className="hover:text-green-400 transition">Login!</Link>
            </p>
            </form>
        </div>
    </div>
